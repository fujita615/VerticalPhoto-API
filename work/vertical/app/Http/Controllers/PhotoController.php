...
class PhotoController extends Controller
{
    ...
    /**
     * Display a listing of the resource.写真の一覧表示
     **/
    public function index()
    {
        $photos = Photo::with(['owner', 'likes', 'tags'])->orderBy(Photo::CREATED_AT, 'desc')->get();
    ...
    public function create(StorePhotoRequest $request)
    {
        ...
        if ($request->tags != null) {
            $tag_ids = Controller::storeTagsId($request->tags);
    ...
    /**
     * Display the specified resource.写真一枚の詳細表示
     */
    ...
    /**
     * Remove the specified resource from storage.写真の削除
     */
    public function destroy(Photo $photo)
    {
        //写真データをDBとstrageから消去する関数
        Controller::deletePhotoData($photo);
