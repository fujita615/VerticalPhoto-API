...
Route::group(['middleware' => config('fortify.middleware', ['web', 'cacheLock']),], function () {
  ...
  if (Features::enabled(Features::updateProfileInformation())) {
    Route::patch(RoutePath::for('user-profile-information.update', '/register'), [ProfileInformationController::class, 'update'])
      ->middleware([config('fortify.auth_middleware', 'auth') . ':' . config('fortify.guard')])
      ->name('user.update');
  }
  ...
  if (Features::enabled(Features::updatePasswords())) {
    Route::put(RoutePath::for('user-password.update', '/register'), [PasswordController::class, 'update'])
      ->middleware([config('fortify.auth_middleware', 'auth') . ':' . config('fortify.guard')])
